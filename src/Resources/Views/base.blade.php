...
<head>
    ...
    <link rel="stylesheet" href="{{route('cron-bundle.assets.css', ['file' => 'bootstrap.min.css'])}}">
    <link rel="stylesheet" href="{{route('cron-bundle.assets.css', ['file' => 'main.css'])}}">
</head>
<body id="cron-bundle">
...
<div class="container my-5 p-3">
    <h1>
        Laravel CronBundle
        <small class="text-muted">by Tolacika</small>
        <a href="https://github.com/Tolacika/laravel-cron-bundle" target="_blank" class="btn btn-outline-dark btn-lg pull-right">
    ...
    <div class="card border-dark">
        <h5 class="card-header bg-secondary text-white clearfix">
            @yield('card-title', "List")
            @yield('card-buttons')
        </h5>
        <div class="card-body">
            @yield('content')
